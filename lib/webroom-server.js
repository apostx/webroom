...
class WebRoomServer extends events.EventEmitter
{
    ...
    constructor(options)
    {
        ...
        this._handleUnifiedData = this._handleUnifiedData.bind(this);
    ...
    {
        socket.once('data', (data) => this._handleUnifiedData(socket, data));
    }
     ...
     * @param {string} data 
     */
    _handleUnifiedData(socket, data)
    {
        ...
        if (answerObj) socket.write(JSON.stringify(answerObj));
        else socket.end();
    }
